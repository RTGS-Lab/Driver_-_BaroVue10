...
class BaroVue10: public Sensor
{
	...
	const uint32_t BAROVUE_QUAL_RANGE = 0xA0040000; //Quality metric error

	public:
		BaroVue10(SDI12Talon& talon_, uint8_t talonPort_ = DEAFULT_PORT, uint8_t sensorPort_ = DEFAULT_SENSOR_PORT, uint8_t version = DEFAULT_VERSION);
